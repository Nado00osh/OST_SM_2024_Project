...
# Load the pre-trained pipeline containing both StandardScaler and Isolation Forest model
        ...
        while True:
            ...
            if new_data:
                ...
                for data in new_data:
                    ...
                    # Predict using the loaded pipeline (StandardScaler + Isolation Forest model)
